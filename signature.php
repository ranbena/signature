      ...
      <td>
        <div style="padding: 10px 0 0 10px;">
          ...
          <div style="margin: 2px 0 0 0; padding: 0; line-height: 18px; font-size: 12px; color: #737373;">
            ...
            <span style="white-space: nowrap; margin-right: 8px;"><a href="skype:<?=$_POST['skype'];?>?call" style="color: #737373; text-decoration: none;"><span><img src="https://s3.amazonaws.com/evme-static-assets/email-signature/skype_icon.png" border="0" valign="middle" width="14" height="18" style="width: 14px; height: 18px; margin-top: -1px; vertical-align: middle;"/></span>&nbsp;<span><?=$_POST['skype'];?></span></a></span>
            <?php endif; ?>
            <?php if (!empty($_POST['facebook'])): ?>
            <span style="white-space: nowrap; margin-right: 8px;"><a href="http://www.facebook.com/<?=$_POST['facebook'];?>" style="color: #737373; text-decoration: none;"><span><img src="https://s3.amazonaws.com/evme-static-assets/email-signature/facebook_icon.png" border="0" valign="middle" width="9" height="18" style="width: 9px; height: 18px; margin-top: -3px; vertical-align: middle;"/></span>&nbsp;<span><?=$_POST['facebook'];?></span></a></span>
            <?php endif; ?>
